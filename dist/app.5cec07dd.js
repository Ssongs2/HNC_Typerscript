  ...
  function NewsDetailView(containerId, store) {
    ...
    _this.render = function () {
      return __awaiter(_this, void 0, Promise, function () {
        var id, api, _a, title, comments, content;
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 1:
              _a = _b.sent(), title = _a.title, comments = _a.comments, content = _a.content;
...
},{"./news-detail.views":"src/page/news-detail.views.ts","./news-feed-view":"src/page/news-feed-view.ts"}],"src/app.ts":[function(require,module,exports) {
"use strict";
...
},{}]},{},["C:/Users/송은지/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/app.ts"], null)
