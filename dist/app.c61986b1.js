...
var NewsFeedView = /** @class */function (_super) {
  ...
  NewsFeedView.prototype.render = function () {
    ...
    this.setTemplateData('prevpage', String(store.currentPage > 1 ? store.currentPage - 1 : 1));
    this.setTemplateData('nextpage', String(store.currentPage + 1 <= store.totalPage ? store.currentPage + 1 : store.currentPage));
  ...
  NewsFeedView.prototype.makeFeeds = function () {
    ...
    store.totalPage = Number(this.feeds.length / 10);
  };
  return NewsFeedView;
}(View);
...
router.route();
},{}],"C:/Users/송은지/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/송은지/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.ts"], null)
